...
class Spaceship {
  ...
  static const Map<SpaceshipType, Spaceship> spaceships = {
    SpaceshipType.canary: Spaceship(
      ...
      speed: 250,
      spriteId: 0,
      assetPath: 'assets/images/1_spiderman.png',
      level: 1,
    ),
    SpaceshipType.dusky: Spaceship(
      ...
      speed: 400,
      spriteId: 1,
      assetPath: 'assets/images/2_iron_man.png',
      level: 2,
    ),
    SpaceshipType.condor: Spaceship(
      ...
      speed: 300,
      spriteId: 2,
      assetPath: 'assets/images/3_black_panther.png',
      level: 2,
    ),
    SpaceshipType.cXC: Spaceship(
      ...
      speed: 300,
      spriteId: 3,
      assetPath: 'assets/images/4_capten_america.png',
      level: 3,
    ),
    SpaceshipType.raptor: Spaceship(
      ...
      speed: 300,
      spriteId: 4,
      assetPath: 'assets/images/5_hulk.png',
      level: 3,
    ),
    SpaceshipType.raptorX: Spaceship(
      ...
      speed: 350,
      spriteId: 5,
      assetPath: 'assets/images/6_dr_strange.png',
      level: 3,
    ),
    SpaceshipType.albatross: Spaceship(
      ...
      speed: 400,
      spriteId: 6,
      assetPath: 'assets/images/7_thor.png',
      level: 4,
    ),
    SpaceshipType.dK809: Spaceship(
      ...
      speed: 450,
      spriteId: 7,
      assetPath: 'assets/images/8_capten_marvel.png',
      level: 4,
    ),
  };
  // static const Map<SpaceshipType, Spaceship> spaceships = {
